...
ICTypeUpdate_PrimitiveSet::Compiler::generateStubCode(MacroAssembler &masm)
{
    ...
    */
    ...
    masm.bind(&success);
    masm.movePtr(ImmWord(1), R1.scratchReg());
    EmitReturnFromIC(masm);
                                      ...
                                      Register argcReg, bool isJitCall)
{
    ...
    masm.movePtr(BaselineStackReg, argPtr);
...
ICCall_Native::Compiler::generateStubCode(MacroAssembler &masm)
{
    ...
    masm.loadValue(Address(BaselineStackReg, NativeExitFrameLayout::offsetOfResult()), R0);
